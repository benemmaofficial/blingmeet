...
<html lang="en">
<head>
<meta charset="utf-8"><title><?= $sm['config']['name']; ?> - <?= $theme; ?> Style & Theme Customizer</title>
...
<?php } ?>
  ...
  <div class="color-picker-panel" style="display: none">
    ...
    <div class="panel-row" data-use-gradients style="display: block">
...
<div class="editor-footer" style="background: #fff;">
  <p style="color: #222"><?= $sm['config']['name']; ?> Theme Customizer
</div>
  ...
  $('[data-theme-setting]').change(function(){    
    ...
    $('[data-theme-setting-click]').click(function(){
      ...
      if(val == 'Top-Menu'){
        ...
        $('[data-segment-require="Left-Menu"]').show();
        $('[data-segment-require="'+val+'"]').show();
      } else {
        $('[data-segment="design_style_wide"]').show();
        $('[data-segment-require="Top-Menu"]').show();
        $('[data-segment-require="'+val+'"]').show();
      }
